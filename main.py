...
def test_prediction(src_dir, dataset_id=0, split_name='train', log_dir='logs', is_online_fig=False):
    ...
    # slam_inc = SLAM()
    slam_inc = pickle.load("SLAM_train_1.pkl")
    # Read data
...
def main():
    ...
    best_p_array = particle_SLAM(args.src_dir, 0, args.split_name, args.running_mode, args.log_dir)
    ...
    #with open('profilingggg.txt', 'w+') as f:
    #    f.write(s.getvalue())
